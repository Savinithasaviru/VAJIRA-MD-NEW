...
global.owner = process.env.OWNER_NUMBER  || '94741834694' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.VAJIRA-MD=yclyhRjJ#GVq99peuWNmDISHycTbejotReTKWK2H4QaXVQ_M3ZmI || ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94741834694" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'SAVIYA' ,
